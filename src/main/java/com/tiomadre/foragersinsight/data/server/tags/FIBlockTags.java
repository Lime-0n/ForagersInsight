...
public class FIBlockTags extends BlockTagsProvider {
    ...
    protected void registerMineables() {
        ...
        this.tag(BlockTags.MINEABLE_WITH_AXE).add(APPLE_CRATE.get(),(BOUNTIFUL_OAK_SAPLING.get()), BOUNTIFUL_DARK_OAK_SAPLING.get(), SAPPY_BIRCH_LOG.get(), BIRCH_POLYPORE.get());
        ...
        this.tag(ModTags.MINEABLE_WITH_KNIFE).add(DANDELION_ROOT_SACK.get(), ROSE_HIP_SACK.get(), POPPY_SEEDS_SACK.get(), SPRUCE_TIPS_SACK.get(), BLACK_ACORN_SACK.get(), BIRCH_POLYPORE.get());
    }

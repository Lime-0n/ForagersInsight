...
public class FIBiomeModifiers {
    ...
    public static void bootstap(BootstrapContext<BiomeModifier> context) {
        ...
        context.register(ADD_ACORN_TREES, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(ADD_LILAC_TREES, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(ADD_SPRUCE_TIP_TREES, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(ADD_SAPPY_BIRCH_TREES, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(ADD_MUSHROOM_BIRCH_TREES, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        //Wild Flower Patches
        context.register(ADD_ROSELLE_BUSHES, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(ADD_BEACH_ROSES, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(ADD_OAK_SUSPICIOUS_LEAF_LITTER, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(ADD_BIRCH_SUSPICIOUS_LEAF_LITTER, new BiomeModifiers.AddFeaturesBiomeModifier(
                tagSet(biomes, FITags.BiomeTag.HAS_BIRCH_FOREST_LITTER),
                HolderSet.direct(placedFeatures.getOrThrow(FIPlacedFeatures.BIRCH_SUSPICIOUS_LEAF_LITTER_PATCH_PLACED_KEY)),
                GenerationStep.Decoration.VEGETAL_DECORATION)
        );
        context.register(ADD_SPRUCE_SUSPICIOUS_LEAF_LITTER, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(ADD_DARK_OAK_SUSPICIOUS_LEAF_LITTER, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(ADD_FLOWER_SUSPICIOUS_LEAF_LITTER, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(ADD_WOODLAND_FERNS, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(ADD_OAK_FALLEN_TREES, new BiomeModifiers.AddFeaturesBiomeModifier(
                tagSet(biomes, FITags.BiomeTag.HAS_OAK_FOREST_LITTER),
                HolderSet.direct(placedFeatures.getOrThrow(FIPlacedFeatures.OAK_FALLEN_TREES_PLACED_KEY)),
                GenerationStep.Decoration.VEGETAL_DECORATION)
        );
        context.register(ADD_BIRCH_FALLEN_TREES, new BiomeModifiers.AddFeaturesBiomeModifier(
                tagSet(biomes, FITags.BiomeTag.HAS_BIRCH_FOREST_LITTER),
                HolderSet.direct(placedFeatures.getOrThrow(FIPlacedFeatures.BIRCH_FALLEN_TREES_PLACED_KEY)),
                GenerationStep.Decoration.VEGETAL_DECORATION)
        );
        context.register(ADD_SPRUCE_FALLEN_TREES, new BiomeModifiers.AddFeaturesBiomeModifier(
                tagSet(biomes, FITags.BiomeTag.HAS_SPRUCE_FOREST_LITTER),
                HolderSet.direct(placedFeatures.getOrThrow(FIPlacedFeatures.SPRUCE_FALLEN_TREES_PLACED_KEY)),
                GenerationStep.Decoration.VEGETAL_DECORATION)
        );
        context.register(ADD_DARK_OAK_FALLEN_TREES, new BiomeModifiers.AddFeaturesBiomeModifier(
                tagSet(biomes, FITags.BiomeTag.HAS_DARK_OAK_FOREST_LITTER),
                HolderSet.direct(placedFeatures.getOrThrow(FIPlacedFeatures.DARK_OAK_FALLEN_TREES_PLACED_KEY)),
                GenerationStep.Decoration.VEGETAL_DECORATION)
        );
        context.register(ADD_FLOWER_FALLEN_TREES, new BiomeModifiers.AddFeaturesBiomeModifier(
                tagSet(biomes, FITags.BiomeTag.HAS_FLOWER_FOREST_LITTER),
                HolderSet.direct(placedFeatures.getOrThrow(FIPlacedFeatures.OAK_FALLEN_TREES_PLACED_KEY)),
                GenerationStep.Decoration.VEGETAL_DECORATION)
        );  //Other
        context.register(ADD_PUDDLES, new BiomeModifiers.AddFeaturesBiomeModifier(
    ...
    public static ResourceKey<BiomeModifier> registerKey(String name) {
        return ResourceKey.create(NeoForgeRegistries.Keys.BIOME_MODIFIERS, ForagersInsight.rl(name));
    }
